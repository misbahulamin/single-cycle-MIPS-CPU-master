...
HD_PWD='C:/Users/DELL/Desktop/LAB2022/shiyan code 202205/shiyan1/shiyan1/shiyan1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_input_nand.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_input_nand.tcl -notrace
